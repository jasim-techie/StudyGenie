...
import { BrainCircuit, Sun, Moon, LogIn, Menu, BookOpen, HelpCircleIcon, Sparkles, LayoutDashboard, UserCircle, Home } from 'lucide-react';
      ...
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <nav className="hidden md:flex items-center gap-1">
            {navLinks.slice(1, 4).map((link) => ( // Show Study Plan, Quiz, Key Points
